...
import serverURL, { getData, postData } from "../server";
...
export default function PostPage() {
  ...
  const [post, setPost] = React.useState({
    title: '', image: '', body:'', ingredients: [], steps: [], author:'', createdAt:'', likes:[], comments:[]
  });
            ...
            <div className="col-lg-6 offset-lg-3">
              <div className="cardbox shadow-lg bg-white">
                <div className="cardbox-heading">
                  ...
                  <div className="media m-0">
                    <div className="d-flex mr-3">
                      <a href><img className="img-fluid rounded-circle" src={post.image} alt="User" /></a>
                    </div>
                ...
                <div className="cardbox-item p-4">
                  <h2>Ingredients</h2>
                  <ul>
                    { post.ingredients.map( ingredient => <li> {ingredient}</li>) }
                  </ul>
                ...
                <div className="cardbox-item p-4">
                  <h2>Steps</h2>
                  <ol>
                    { post.steps.map(step => <li>{step}</li>) }
                  </ol>
